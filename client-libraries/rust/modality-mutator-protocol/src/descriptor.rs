use crate::attrs::{AttrKey, AttrVal};
...
pub mod owned {
    ...
    impl OwnedMutatorParamDescriptor {
        pub(crate) fn mutator_params_param_key_prefixed_attributes(
            ...
            let mut param_prefix = crate::params_attributes::MUTATOR_PARAMS_PREFIX.to_string();
            ...
            param_attrs.push((
                AttrKey::from(format!(
                    "{param_prefix}{}",
                    crate::params_attributes::MUTATOR_PARAMS_NAME_SUFFIX
                )),
            ...
            param_attrs.push((
                AttrKey::from(format!(
                    "{param_prefix}{}",
                    crate::params_attributes::MUTATOR_PARAMS_VALUE_TYPE_SUFFIX
                )),
            ...
            if let Some(param_description) = self.description.as_ref() {
                param_attrs.push((
                    AttrKey::from(format!(
                        "{param_prefix}{}",
                        crate::params_attributes::MUTATOR_PARAMS_DESCRIPTION_SUFFIX
                    )),
            ...
            if let Some(value_min) = self.value_min.as_ref() {
                param_attrs.push((
                    AttrKey::from(format!(
                        "{param_prefix}{}",
                        crate::params_attributes::MUTATOR_PARAMS_VALUE_MIN_SUFFIX
                    )),
                    value_min.clone(),
                ));
            }
            if let Some(value_max) = self.value_max.as_ref() {
                param_attrs.push((
                    AttrKey::from(format!(
                        "{param_prefix}{}",
                        crate::params_attributes::MUTATOR_PARAMS_VALUE_MAX_SUFFIX
                    )),
                    value_max.clone(),
                ));
            }
            if let Some(default_value) = self.default_value.as_ref() {
                param_attrs.push((
                    AttrKey::from(format!(
                        "{param_prefix}{}",
                        crate::params_attributes::MUTATOR_PARAMS_DEFAULT_VALUE_SUFFIX
                    )),
                    default_value.clone(),
                ));
            }
            if let Some(least_effect_value) = self.least_effect_value.as_ref() {
                param_attrs.push((
                    AttrKey::from(format!(
                        "{param_prefix}{}",
                        crate::params_attributes::MUTATOR_PARAMS_LEAST_EFFECT_VALUE_SUFFIX
                    )),
            ...
            if let Some(value_distribution_kind) = self.value_distribution_kind.as_ref() {
                param_attrs.push((
                    AttrKey::from(format!(
                        "{param_prefix}{}",
                        crate::params_attributes::MUTATOR_PARAMS_VALUE_DISTRIBUTION_KIND_SUFFIX
                    )),
            ...
            if let Some(value_distribution_scaling) = self.value_distribution_scaling.as_ref() {
                param_attrs.push((
                    AttrKey::from(format!(
                        "{param_prefix}{}",
                        crate::params_attributes::MUTATOR_PARAMS_VALUE_DISTRIBUTION_SCALING_SUFFIX
                    )),
            ...
            if let Some(option_set) = self.value_distribution_option_set.as_ref() {
                ...
                for (option_key_segment, option_val) in option_set {
                    param_attrs.push((AttrKey::from(format!("{param_prefix}{}{}", crate::params_attributes::MUTATOR_PARAMS_VALUE_DISTRIBUTION_OPTION_SET_INTERFIX, option_key_segment)), option_val.clone()));
                }
            }
