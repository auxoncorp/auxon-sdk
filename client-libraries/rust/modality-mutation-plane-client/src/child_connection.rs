...
use modality_mutation_plane::modality_mutator_protocol::attrs::{AttrKey, AttrVal};
use modality_mutation_plane::protocol::{
    LeafwardsMessage, RootwardsMessage, MUTATION_PROTOCOL_VERSION,
};
use modality_mutation_plane::types::{ParticipantId, TriggerCRDT};
...
pub enum Rootwards {
    ...
    MutatorAnnouncement {
        ...
        mutator_id: modality_mutation_plane::types::MutatorId,
    ...
    UpdateTriggerState {
        ...
        mutator_id: modality_mutation_plane::types::MutatorId,
        mutation_id: modality_mutation_plane::types::MutationId,
